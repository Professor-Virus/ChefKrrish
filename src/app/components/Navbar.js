...
export default function Navbar({ onLogout }) {
  ...
  return (
    <header className="bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-900 text-white p-4 shadow-md flex items-center justify-between">
      ...
      <nav className="hidden lg:flex space-x-4">
        <button onClick={handleLogout} className="bg-gray-900 hover:bg-gray-700 text-white py-2 px-4 rounded">
          Logout
        </button>
      </nav>
